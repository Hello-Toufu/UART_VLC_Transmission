...
module RS_DE_LANE_QUATUS (
	...
	wire [8:1] signal_wire1 = 8'b0;
	wire signal_wire2 = 1'b0;

	auk_rs_dec_top_atl	auk_rs_dec_top_atl_inst(
		.clk(clk),
		.reset(reset),
		.rsin(rsin),
		.sink_val(sink_val),
	...
	defparam
		auk_rs_dec_top_atl_inst.m = 8,
		auk_rs_dec_top_atl_inst.n = 40,
		auk_rs_dec_top_atl_inst.check = 8,
		auk_rs_dec_top_atl_inst.genstart = 0,
		auk_rs_dec_top_atl_inst.irrpol = 285,
		auk_rs_dec_top_atl_inst.rootspace = 1,
		auk_rs_dec_top_atl_inst.wide = 4,
		auk_rs_dec_top_atl_inst.bitwide = 6,
		auk_rs_dec_top_atl_inst.keysize = "full",
		auk_rs_dec_top_atl_inst.Erasures = "false",
		auk_rs_dec_top_atl_inst.Varcheck = "false",
		auk_rs_dec_top_atl_inst.rserr_connect = "true",
		auk_rs_dec_top_atl_inst.err_bit_connect = "false",
		auk_rs_dec_top_atl_inst.inv_file = "RS_DE_LANE_QUATUS_inv_8_285.hex";
endmodule
...
// Retrieval info:      <PRIVATE name = "rserr_connect" value="true"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="RS_DE_LANE_QUATUS.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "greybox">
// Retrieval info:      <PRIVATE name = "filename" value="RS_DE_LANE_QUATUS_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:     <CONSTANT name = "bitwide" value="6"  type="INTEGER" />
// Retrieval info:     <CONSTANT name = "keysize" value="full"  type="STRING" />
...
// Retrieval info:     <CONSTANT name = "rserr_connect" value="true"  type="STRING" />
// Retrieval info:     <CONSTANT name = "err_bit_connect" value="false"  type="STRING" />
// Retrieval info:     <CONSTANT name = "inv_file" value="RS_DE_LANE_QUATUS_inv_8_285.hex"  type="STRING" />
// Retrieval info:    </CONSTANTS>
...
// Retrieval info:     <PORT name = "num_err_sym" direction="OUTPUT"  connect_to="num_err_sym"  default="NODEFVAL"  high_width="4"  low_width="1"  description="" />
// Retrieval info:     <PORT name = "rserr" direction="OUTPUT"  connect_to="rserr"  default="NODEFVAL"  high_width="8"  low_width="1"  description="" />
// Retrieval info:    </PORTS>
...
// =========================================================
// RELATED_FILES: RS_DE_LANE_QUATUS.v;
// IPFS_FILES: RS_DE_LANE_QUATUS.vo;
// =========================================================
