...
// MTL <-> Rx Frame Length FIFO read interface
 ...
 output                          rrc_rd_en_o;    // Read enable from RxData FIFO
  ...
  input                  rst_clk_tx_180_n;      // Active Low reset sync to clk_tx_180_i.
  input                  clk_rx_180_i;          // 180 phase shifter clk_rx_i.
  input                  rst_clk_rx_180_n;      // Active Low reset synch to clk_tx_180_i.
...
DWC_gmac
 DWC_gmac_inst(
          .clk_tx_i(clk_tx_i),       
                       ...
                       .mac_portselect_o(mac_portselect_o), 
