...
// ---------------------------------------------
  ...
  wire      thresh_deact_u; //MSB of Flowcontrol De-active Threshold 
  wire      thresh_act_u;   //MSB of Flowcontrol active Threshold 

  wire       hwfloctrl_e;    // Hardware Flowcontrol Enable
  wire [1:0] thresh_deact_l; //LSB of Flowcontrol De-active Threshold 
  wire [1:0] thresh_act_l;   //LSB of Flowcontrol active Threshold 
...
// ---------------------------------------------------------------------
  ...
  // These register bit are reserved
   assign thresh_act_u   = 1'b0;
   assign thresh_deact_u = 1'b0;
  ...
  // These register bit are reserved
   assign thresh_deact_l = 2'b00;
   assign thresh_act_l   = 2'b00;
   assign hwfloctrl_e    = 1'b0;
