...
// Default:      0 (value changes dynamically based on a command)
// Values:       0, 1
// 
...
// Name:         BLW
// Default:      4 (value changes dynamically based on a command)
// Values:       4, ..., 8
// Enabled:      GMAC == 4
// 
...
// Name:         OP_MODE
// Default:      {10/100/1000 Mbps} (value changes dynamically based on a command)
...
// Name:         STS_PTR_WIDTH
// Default:      3 (value changes dynamically based on a command)
// Values:       1, ..., 3
// 
// Address width of Tx status FIFO
`define STS_PTR_WIDTH 3
...
// `define MAX_FRAME_IN_TXFIFO_2


// Name:         RX_FIFO_PTR_WIDTH
// Default:      13 (value changes dynamically based on a command)
// Values:       3, ..., 13
// Enabled:      RXFIFO_SIZE
// 
...
`define ARI_PBL_WIDTH 12


// Name:         FIFO_DATA_WIDTH
// Default:      35 (value changes dynamically based on a command)
// Values:       35, ..., 133
// Enabled:      GMAC != 1
// 
...
// Default:      12 (value changes dynamically based on a command)
// Values:       4, ..., 12
// Enabled:      GMAC != 1
// 
...
`define ATI_PBL_WIDTH 11


// Name:         ADDR_OFFSET_MSB
// Default:      1 (value changes dynamically based on a command)
// Values:       1, ..., 3
// Enabled:      GMAC != 1
// 
// ADDR OFFSET MSB
...
// Name:         ADDR_BASE_LSB
// Default:      2 (value changes dynamically based on a command)
// Values:       2, ..., 4
...
// Name:         ADDR_BASE_SIZE
// Default:      30 (value changes dynamically based on a command)
// Values:       28, ..., 30
// Enabled:      GMAC==0||GMAC == 3||GMAC==4
// 
...
// Name:         SIZE_BASE_SIZE
// Default:      9 (value changes dynamically based on a command)
// Values:       7, ..., 11
// Enabled:      GMAC==0||GMAC == 3||GMAC==4
// 
// Base size MDC block
...
// Default:      10 (value changes dynamically based on a command)
// Values:       8, ..., 12
// Enabled:      GMAC==0||GMAC == 3||GMAC==4
// 
...
// Name:         DESC_ADDR_MSB
// Default:      29 (value changes dynamically based on a command)
// Values:       27, ..., 29
// Enabled:      GMAC==0||GMAC == 3||GMAC==4
// 
...
// Default:      8 (value changes dynamically based on a command)
// Values:       6, ..., 8
// Enabled:      GMAC==0||GMAC == 3||GMAC==4
// 
// RX Buffer Size MSB
...
// Default:      4094 (value changes dynamically based on a command)
// Values:       6, ..., 4094
// Enabled:      GMAC!=1
// 
// Giant Frame Threshold
`define GNT_FRAME_THRSHLD 4094
...
// Values:       false (0), true (1)
// 
// If true, AXI rready and bready inputs are combinationally connected 
// to 
//  GIF mready outputs. 
//  If false, AXI rready and bready inputs 
// are registered, inserting one 
//  cycle of latency.
...
// Values:       1 2 3 4
// 
// Depth of GIF response buffer. Higher values allow GIF responses to 
// be 
//  buffered, rather than stalled, if AXI read data or write 
// response 
