...
-- functions, tasks
  ...
  begin
  glblGSR     <= TO_X01(GSR); --这个GSR包括转0，1，X的函数需要注意。
...
--modified by wangpeng 2017.07.05, 删除Z判断赋值。  
  ACIN_in <= ACIN;
  ALUMODE_in(0) <= ALUMODE(0) xor IS_ALUMODE_INVERTED_BIN(0); -- rv 0
  ALUMODE_in(1) <= ALUMODE(1) xor IS_ALUMODE_INVERTED_BIN(1); -- rv 0
  ALUMODE_in(2) <= ALUMODE(2) xor IS_ALUMODE_INVERTED_BIN(2); -- rv 0
  ALUMODE_in(3) <= ALUMODE(3) xor IS_ALUMODE_INVERTED_BIN(3); -- rv 0
  A_in(0) <= A(0); -- rv 1
  A_in(1) <= A(1); -- rv 1
  A_in(10) <= A(10); -- rv 1
  A_in(11) <= A(11); -- rv 1
  ...
  CARRYINSEL_in(0) <=  CARRYINSEL(0); -- rv 0
  CARRYINSEL_in(1) <=  CARRYINSEL(1); -- rv 0
  CARRYINSEL_in(2) <=  CARRYINSEL(2); -- rv 0
  CARRYIN_in <=  CARRYIN xor IS_CARRYIN_INVERTED_BIN; -- rv 0
  CEA1_in <=  CEA1; -- rv 0
  CEA2_in <=  CEA2; -- rv 0
  CEAD_in <=  CEAD; -- rv 0
  CEALUMODE_in <= CEALUMODE; -- rv 0
  CEB1_in <=  CEB1; -- rv 0
  CEB2_in <=  CEB2; -- rv 0
  CECARRYIN_in <=  CECARRYIN; -- rv 0
  CECTRL_in <=  CECTRL; -- rv 0
  CEC_in <= CEC; -- rv 0
  CED_in <= CED; -- rv 0
  CEINMODE_in <= CEINMODE;
  CEM_in <= CEM; -- rv 0
  CEP_in <= CEP; -- rv 0
  CLK_in <= CLK xor IS_CLK_INVERTED_BIN; -- rv 0
  CLK_areg1 <=CLK xor IS_CLK_INVERTED_BIN;
  CLK_areg2 <=CLK xor IS_CLK_INVERTED_BIN;
  CLK_breg1 <=CLK xor IS_CLK_INVERTED_BIN;
  CLK_breg2 <=CLK xor IS_CLK_INVERTED_BIN;
  CLK_creg  <=CLK xor IS_CLK_INVERTED_BIN;
  CLK_mreg  <=CLK xor IS_CLK_INVERTED_BIN;
  CLK_inmode <= CLK xor IS_CLK_INVERTED_BIN;
  CLK_dreg   <= CLK xor IS_CLK_INVERTED_BIN;
  CLK_adreg  <= CLK xor IS_CLK_INVERTED_BIN;
  CLK_preg  <= CLK xor IS_CLK_INVERTED_BIN;
  C_in(0) <=  C(0); -- rv 1
  C_in(1) <=  C(1); -- rv 1
  C_in(10) <= C(10); -- rv 1
  C_in(11) <= C(11); -- rv 1
  ...
  D_in(8) <= D(8); -- rv 0
  D_in(9) <= D(9); -- rv 0
  INMODE_in(0) <=  INMODE(0) xor IS_INMODE_INVERTED_BIN(0); -- rv 0
  INMODE_in(1) <=  INMODE(1) xor IS_INMODE_INVERTED_BIN(1); -- rv 0
  INMODE_in(2) <=  INMODE(2) xor IS_INMODE_INVERTED_BIN(2); -- rv 0
  INMODE_in(3) <=  INMODE(3) xor IS_INMODE_INVERTED_BIN(3); -- rv 0
  INMODE_in(4) <=  INMODE(4) xor IS_INMODE_INVERTED_BIN(4); -- rv 0
  MULTSIGNIN_in <= MULTSIGNIN;
  OPMODE_in(0) <= OPMODE(0) xor IS_OPMODE_INVERTED_BIN(0); -- rv 0
  OPMODE_in(1) <= OPMODE(1) xor IS_OPMODE_INVERTED_BIN(1); -- rv 0
  OPMODE_in(2) <= OPMODE(2) xor IS_OPMODE_INVERTED_BIN(2); -- rv 0
  OPMODE_in(3) <= OPMODE(3) xor IS_OPMODE_INVERTED_BIN(3); -- rv 0
  OPMODE_in(4) <= OPMODE(4) xor IS_OPMODE_INVERTED_BIN(4); -- rv 0
  OPMODE_in(5) <= OPMODE(5) xor IS_OPMODE_INVERTED_BIN(5); -- rv 0
  OPMODE_in(6) <= OPMODE(6) xor IS_OPMODE_INVERTED_BIN(6); -- rv 0
  OPMODE_in(7) <= OPMODE(7) xor IS_OPMODE_INVERTED_BIN(7); -- rv 0
  OPMODE_in(8) <= OPMODE(8) xor IS_OPMODE_INVERTED_BIN(8); -- rv 0
  PCIN_in <= PCIN;
  RSTALLCARRYIN_in <= RSTALLCARRYIN xor IS_RSTALLCARRYIN_INVERTED_BIN; -- rv 0
  RSTALUMODE_in <=  RSTALUMODE xor IS_RSTALUMODE_INVERTED_BIN; -- rv 0
  RSTA_in <=  RSTA xor IS_RSTA_INVERTED_BIN; -- rv 0
  RSTB_in <=  RSTB xor IS_RSTB_INVERTED_BIN; -- rv 0
  RSTCTRL_in <= RSTCTRL xor IS_RSTCTRL_INVERTED_BIN; -- rv 0
  RSTC_in <=  RSTC xor IS_RSTC_INVERTED_BIN; -- rv 0
  RSTD_in <=  RSTD xor IS_RSTD_INVERTED_BIN; -- rv 0
  RSTINMODE_in <=  RSTINMODE xor IS_RSTINMODE_INVERTED_BIN; -- rv 0
  RSTM_in <=  RSTM xor IS_RSTM_INVERTED_BIN; -- rv 0
  RSTP_in <=  RSTP xor IS_RSTP_INVERTED_BIN; -- rv 0
...
--modified by wangpeng 2017.07.05 error message  
--  INIPROC : process
...
--  wait;
--  end process INIPROC;
--End modification by wangpeng 2017.07.05 error message
...
--modified by wangpeng 2017.07.05
...
--     end if;
--  end process cis_drc;     
--End modification by wangpeng 2017.07.05
