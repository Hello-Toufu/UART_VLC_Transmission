...
//   output_name:        my_ps_avalon_st_adapter_001_timing_adapter_0
//   in_use_ready:       true
//   out_use_ready:      true
//   in_use_valid:       true
//   out_use_valid:      true
...
module my_ps_avalon_st_adapter_001_timing_adapter_0
(  
 output reg         in_ready,
 input               in_valid,
 ...
 /*AUTOARG*/);
   ...
   //| FIFO
   // ---------------------------------------------------------------------                           
   my_ps_avalon_st_adapter_001_timing_adapter_0_fifo my_ps_avalon_st_adapter_001_timing_adapter_0_fifo 
     ( 
       .clk        (clk),
       .reset_n    (reset_n),
       .in_ready   (),
